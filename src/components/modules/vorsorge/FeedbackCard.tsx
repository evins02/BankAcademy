...
export function FeedbackCard({
  ...
  const isCorrect = selectedOption === vorsorgeCase.correct;
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="rounded-DEFAULT bg-surface p-6 shadow-card">
        ...
        <ActiveRecallPrompt
          feedback={vorsorgeCase.feedback}
          promptText={`Begründe in deinen eigenen Worten: ${vorsorgeCase.question}`}
          caseBriefing={vorsorgeCase.situation}
          ...
          <>
            <div className="mb-5 flex flex-col gap-2">
              {vorsorgeCase.options.map((opt) => {
                ...
                const isCorrectOpt = opt.key === vorsorgeCase.correct;
                return (
                  <div
                    key={opt.key}
                    className={cn(
