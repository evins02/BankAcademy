...
export function LevelSelector({ completedLevels, levelScores, onSelectLevel }: LevelSelectorProps) {
  return (
    <div className="mx-auto max-w-2xl">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-text-primary">Anlegerprofil</h2>
        <p className="mt-1 text-sm text-text-secondary">
          Lerne Anlegerprofile korrekt zu bestimmen und Kunden richtig zu beraten.
        </p>
      </div>
      <div className="grid gap-4 sm:grid-cols-3">
        {AL_LEVELS.map(({ level, label, badgeVariant, scenarios }) => {
